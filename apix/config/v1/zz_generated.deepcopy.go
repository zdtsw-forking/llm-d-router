...
func (in *CrossReplicaConfig) DeepCopyInto(out *CrossReplicaConfig) {
	*out = *in
	...
	if in.PublishTimeout != nil {
		in, out := &in.PublishTimeout, &out.PublishTimeout
		*out = new(metav1.Duration)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CrossReplicaConfig.
func (in *CrossReplicaConfig) DeepCopy() *CrossReplicaConfig {
	if in == nil {
		return nil
	}
	out := new(CrossReplicaConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DataLayerConfig) DeepCopyInto(out *DataLayerConfig) {
	*out = *in
	...
	if in.CrossReplica != nil {
		in, out := &in.CrossReplica, &out.CrossReplica
		*out = new(CrossReplicaConfig)
		(*in).DeepCopyInto(*out)
	}
}
